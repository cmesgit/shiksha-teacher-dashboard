  ...
  return (
    <div className="gs-control-bar">
      ...
      <div className="gs-cb-center">
        <button className="gs-cb-btn" onClick={toggleMic} disabled={micBusy} title={micError || (micOn ? "Mute" : "Unmute")} data-tour="live-room.mic">
        ...
        <button className="gs-cb-btn" onClick={toggleVideo} disabled={videoBusy} title={videoError || (videoOn ? "Turn off camera" : "Turn on camera")} data-tour="live-room.camera">
        ...
        {isStudent && (
          <button className="gs-cb-btn" onClick={toggleHand} title={handRaised ? "Lower hand" : "Raise hand"} data-tour="live-room.raise-hand">
        ...
        <button className="gs-cb-btn" onClick={leaveRoom} title="Leave session" data-tour="live-room.leave">
      ...
      <div className="gs-cb-right">
        ...
        <button className={`gs-cb-side-btn ${activePanel === "chat" ? "gs-cb-side-btn--active" : ""}`} onClick={() => onTogglePanel("chat")} title="Chat" data-tour="live-room.chat-toggle">
        ...
        <button className={`gs-cb-side-btn ${activePanel === "files" ? "gs-cb-side-btn--active" : ""}`} onClick={() => onTogglePanel("files")} title="Files">
